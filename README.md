...
This repository holds the split version of the Colab audiobook pipeline:

- `audiobook_pipeline_colab_loader_v2.ipynb`: the stable Colab loader notebook
...
1. Keep `audiobook_pipeline_colab_loader_v2.ipynb` in Colab.
